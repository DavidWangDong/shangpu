		...
		return {
			...
			proList: [
				...
				{ 
					...
					children:[
						{ name: '2017最佳商业运营操盘手', celltype: 7, listName: '姓名',renderType:'peo'},
						{ name: '2017最佳商业销售操盘手', celltype: 8, listName: '姓名', renderType: 'peo'},
					],
				},
				{ 
					type: 3,
					...
					children:[
						{ name: '2017年度最佳运营商', celltype: 9, listName: '街区名'},
						{ name: '2017年度消费者最喜爱安徽品牌商户', celltype: 10, listName: '街区名'},
						{ name: '2017年度最佳商业地产开发企业', celltype: 11, listName: '街区名'},
					],
				 },
			]
		}
